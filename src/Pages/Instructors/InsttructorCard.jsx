const InstructorCard = ({item}) => {
    const {photo,email,name}=item
    return (
        <div>
            <div className="flex flex-col justify-center max-w-sm p-6 shadow-md rounded-xl sm:px-12 bg-slate-400 text-gray-100">
                <img src={photo} alt="" className="w-36 h-36 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
