        ...
        <div className="card card-compact w-96 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-center mt-5">
                    <button onClick={() => handleCart(item)} disabled={loggedUser?.role === "admin" || loggedUser?.role === "instructor"} className="btn btn-outline border-t-0 border-x-0 border-b-4 btn-accent">Purchase</button>
                </div>
            </div>
        </div>
